...
$processPattern = '(?i)\b(?:ld|ld\.lld|lld-link|collect2|gcc|g\+\+|clang|clang\+\+|cc1|cc1plus|lto1|lto-wrapper|as|v|v3-gui-[a-z0-9._-]+|vglyph_[a-z0-9._-]+|showcase_[a-z0-9._-]+|pango_static_[a-z0-9._-]+|gettext_static_[a-z0-9._-]+)\.exe\b'
